...
<h3 class="fs-4 mb-3">Exhibitions</h3>
                                       <thread>
...
try {
    ...
    // Display all artists
    PreparedStatement displayStmt = conn.prepareStatement("SELECT * FROM EXHIBITION");
    ResultSet artistsResult = displayStmt.executeQuery();

  while (artistsResult.next()) {
        int artistId = artistsResult.getInt("E_id");
        String artistName = artistsResult.getString("E_name");
        String artistAddress = artistsResult.getString("LOCATION");
        String date = artistsResult.getString("START_DATE");
        String edate = artistsResult.getString("END_DATE");
