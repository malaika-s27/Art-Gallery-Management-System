...
<body>
    ...
    try {
        ...
        if (idToRemove != null && !idToRemove.isEmpty()) {
            ...
            String deleteQuery = "DELETE FROM Gallery WHERE G_ID=?";
        ...
        if (name != null && !name.isEmpty()  && location != null
            ...
            String insertQuery = "INSERT INTO GALLERY (G_ID, G_NAME, LOCATION) VALUES (?,?,?)";
            ...
            <div class="row my-5">
                <div class="col">
                    <div class="prominent-label">
                        <h3 class="fs-4 mb-3">List of Galleries </h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="">
                                            <input type="hidden" name="removeId" value="<%= resultSet.getString("G_ID") %>">
                    ...
                    <div class="prominent-label">
                        <h3 class="fs-4 mb-3">Add new Gallery</h3>
                    </div>
                    <form class="form-horizontal" role="form" id="profile-form" method="post">
                        <div class="form-group">
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="id" value="" placeholder="Enter Gallery ID" required>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="name" placeholder="Enter Gallery Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-8">
